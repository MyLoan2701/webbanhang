...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(empty($error))
    {
        ...
        else
        {
            ...
            {
                $data2['id'] = $id_insert;
                $id_insert2 = $db->insert("laptop",$data2);
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Thêm mới laptop</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">
                    <a href="index.php">Bảng điều khiển</a>
                </li>
                <li class="breadcrumb-item active">Thêm mới laptop</li>
            </ol>
            ...
            <div class="card mb-4">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="input2" 
                            name="number" placeholder="100" value="100">
                    ...
                    <label for="input2" class="col-sm-2 text-right">Thiết Kế</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="ThietKe" value="<?php echo $data2['ThietKe'] ?>">
                        </div>
                    </div>

                    <div class="form-group row">
                    <label for="input2" class="col-sm-2 text-right">Kích thước</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="KichThuoc" value="<?php echo $data2['KichThuoc'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">Web Cam</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="WebCam" value="<?php echo $data2['WebCam'] ?>">
                        </div>
                    </div>
