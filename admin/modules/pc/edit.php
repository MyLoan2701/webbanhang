...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(empty($error))
    {
        ...
        else
        {
            ...
            $id_update2 = $db->update("pc",$data2,array("id" => $id));
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Cập nhật PC</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">
                    <a href="index.php">Bảng điều khiển</a>
                </li>
                <li class="breadcrumb-item active">Cập nhật PC</li>
            </ol>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="input2" class="col-sm-2 text-right">Công nghệ CPU</label>
                        <div class="col-sm-8">
                            ...
                            name="CongNgheCPU" value="<?php echo $EditProduct2['CongNgheCPU'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">Ổ đĩa quang</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="ODiaQuang" value="<?php echo $EditProduct2['ODiaQuang'] ?>">
                        </div>
                    </div>
