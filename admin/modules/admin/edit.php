            ...
            <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            placeholder="Nguyễn Văn A" value="<?php echo $Editadmin['name'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            placeholder="5 Tôn Đức Thắng" value="<?php echo $Editadmin['address'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            placeholder="0123456789" value="<?php echo $Editadmin['phone'] ?>">
                    ...
                    <div class="form-group row">
                        <label for="input1" class="col-sm-2 text-right">Mật Khẩu</label>
                        <div class="col-sm-8">
                            <input type="password" class="form-control" id="input2" name="password" 
                            placeholder="*****" value="<?php echo $Editadmin['password'] ?>">
                    ...
                    <div class="form-group row">
                        <label for="input1" class="col-sm-2 text-right">Nhập Lại Mật Khẩu</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="input1" class="col-sm-2 text-right">Cấp Bậc</label>
                        <div class="col-sm-8">
                            <select class="form-control" name="level">

                            <option value="1" <?php echo isset($data['level']) && $Editadmin['level'] == 1 ? "selected = 'selected'" : "" ?>>
                                CTV
                            </option>
                            <?php if ($_SESSION['admin_lv'] == 2): ?>
                            <option value="2" <?php echo isset($data['level']) && $Editadmin['level'] == 2 ? "selected = 'selected'" : "" ?>>
                                Admin
                            </option>
                            <?php endif ?>
