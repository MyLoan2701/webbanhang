...
$EditProduct2 = $db->fetchID("manhinh",$id);
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(empty($error))
    {
        ...
        else
        {
            ...
            $id_update2 = $db->update("manhinh",$data2,array("id" => $id));
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Cập nhật màn hình</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">
                    <a href="index.php">Bảng điều khiển</a>
                </li>
                <li class="breadcrumb-item active">Cập nhật màn hình</li>
            </ol>
            ...
            <div class="card mb-4">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="input2" class="col-sm-2 text-right">Độ phân giải</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="DoPhanGiai" value="<?php echo $EditProduct2['DoPhanGiai'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">Công nghệ</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="CongNghe" value="<?php echo $EditProduct2['CongNghe'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">Độ tương phản</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="DoTuongPhan" value="<?php echo $EditProduct2['DoTuongPhan'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">Thời gian đáp ứng</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="ThoiGianDapUng" value="<?php echo $EditProduct2['ThoiGianDapUng'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">Góc nhìn</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="GocNhin" value="<?php echo $EditProduct2['GocNhin'] ?>">
                        </div>
                    </div>
