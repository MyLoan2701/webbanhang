...
$EditProduct2 = $db->fetchID("tablet",$id);
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(empty($error))
    {
        ...
        else
        {
            ...
            $id_update2 = $db->update("tablet",$data2,array("id" => $id));
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Cập nhật Tablet</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">
                    <a href="index.php">Bảng điều khiển</a>
                </li>
                <li class="breadcrumb-item active">Cập nhật Tablet</li>
            </ol>
            ...
            <div class="card mb-4">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="input2" class="col-sm-2 text-right">Bộ nhớ trong</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="BoNhoTrong" value="<?php echo $EditProduct2['BoNhoTrong'] ?>">
                        </div>
                    </div>
