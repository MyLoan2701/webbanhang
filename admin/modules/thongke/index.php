...
$sql4 = "SELECT COUNT(`id`) FROM admin";
$dem4 = $db->total($sql4);
                ...
                aria-describedby="dataTable_info" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $dem3['COUNT(`id`)'] ." khách hàng" ?></td>
                            <td class="text-center">
                                <a class="btn btn-xs btn-info" href="/webbanhang/admin/modules/user/index.php">Đến</a>
                            </td>
                        </tr>
                        
                        <tr>
                            <td>Số lượng nhân viên</td>
                            <td><?php echo $dem4['COUNT(`id`)'] ." nhân viên" ?></td>
                            <td class="text-center">
                                <a class="btn btn-xs btn-info" href="/webbanhang/admin/modules/admin/index.php">Đến</a>
                            </td>
                        </tr>
