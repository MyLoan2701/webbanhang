        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="input2" class="col-sm-2 text-right">Tên sản phẩm</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="input2" name="number"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="input3" name="sale" 
                            placeholder="10%" value="<?php echo $EditProduct['sale'] ?>">
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            name="thundar" value="">
                            <img src="<?php echo uploads(); ?>product/<?php echo $EditProduct['thundar'] ?>"
                    ...
                    <?php if ($accessories['slug'] == "sac-du-phong"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['performance'] ?>">
                            </div>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if ($accessories['slug'] == "sac-du-phong"  || $accessories['slug'] == "the-nho" || $accessories['slug'] == "usb"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['capacity'] ?>">
                            </div>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if($accessories['slug'] == "sac-du-phong"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['input'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($accessories['slug'] == "sac-du-phong" || $accessories['slug'] == "adapter-sac" || $accessories['slug'] == "cap-sac"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['output'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "sac-du-phong"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['core'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "sac-du-phong" || $accessories['slug'] == "adapter-sac" || $accessories['slug'] == "loa"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['extensions'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "sac-du-phong" || $accessories['slug'] == "chuot" || $accessories['slug'] == "pk-ipad" || $accessories['slug'] == "ban-phim"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['weight'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "tai-nghe" || $accessories['slug'] == "loa"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['slot'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "loa"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['other'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "ban-phim"): ?>
                        <div class="form-group row">
                            <label for="input1" class="col-sm-3 text-right">Số phím</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="input1" name="other" 
                                value="<?php echo $EditProduct2['other'] ?>">
                            </div>
                    ...
                    <?php if($accessories['slug'] == "tai-nghe"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['connected'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "the-nho" || $accessories['slug'] == "usb"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['speed'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "the-nho" || $accessories['slug'] == "usb"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['rs'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "the-nho" || $accessories['slug'] == "usb"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['ws'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "tai-nghe" || $accessories['slug'] == "loa" || $accessories['slug'] == "chuot" || $accessories['slug'] == "pk-ipad" || $accessories['slug'] == "ban-phim"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['compatible'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "loa"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['speaker'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($accessories['slug'] == "loa" || $accessories['slug'] == "usb"|| $accessories['slug'] == "pk-ipad" || $accessories['slug'] == "sac-du-phong" || $accessories['slug'] == "ban-phim"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['size'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($accessories['slug'] == "chuot"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['dpi'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($accessories['slug'] == "pk-ipad"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['feature'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($accessories['slug'] == "pk-ipad" || $accessories['slug'] == "tai-nghe" || $accessories['slug'] == "loa" || $accessories['slug'] == "sac-du-phong"): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                value="<?php echo $EditProduct2['usedtime'] ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            value="<?php echo $EditProduct2['made'] ?>">
                        </div>
                    </div>
