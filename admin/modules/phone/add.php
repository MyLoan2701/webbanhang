...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Thêm mới điện thoại</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">
                    <a href="index.php">Bảng điều khiển</a>
                </li>
                <li class="breadcrumb-item active">Thêm mới điện thoại</li>
            </ol>
            ...
            <div class="card mb-4">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="input2" class="col-sm-2 text-right">ROM</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="ROM" value="<?php echo $data2['ROM'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">SDCar</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="SDCar" value="<?php echo $data2['SDCar'] ?>">
                        </div>
                    </div>
