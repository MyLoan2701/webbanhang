...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Cập nhật điện thoại</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">
                    <a href="index.php">Bảng điều khiển</a>
                </li>
                <li class="breadcrumb-item active">Cập nhật điện thoại</li>
            </ol>
            ...
            <div class="card mb-4">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="input2" class="col-sm-2 text-right">Danh mục điện thoại</label>
                        <div class="col-sm-8">
                    ...
                    <label for="input2" class="col-sm-2 text-right">Cam trước</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="Camtruoc" value="<?php echo $EditProduct2['Camtruoc'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">Cam sau</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="Camsau" value="<?php echo $EditProduct2['Camsau'] ?>">
                        </div>
                    </div>
                    ...
                    <label for="input2" class="col-sm-2 text-right">ROM</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="ROM" value="<?php echo $EditProduct2['ROM'] ?>">
                        </div>
                    </div>

                    <div class="form-group row">
                    <label for="input2" class="col-sm-2 text-right">SDCar</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="input2" 
                            name="SDCar" value="<?php echo $EditProduct2['SDCar'] ?>">
                        </div>
                    </div>
