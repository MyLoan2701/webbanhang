        ...
        <div class="container-fluid">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                        <label for="input3" class="col-sm-2 text-right">Yêu cầu</label>
                        <div class="col-sm-8">
                        <input type="tel" class="form-control" id="input3" name="other" 
                        placeholder="Yêu cầu khách hàng" value="<?php echo $EditOrder['other'] ?>">
                            <?php if (isset($error['other'])): ?>
                                <p class="text-danger"> <?php echo $error['other']; ?> </p>
                            <?php endif ?>
                        </div>
                    </div>
